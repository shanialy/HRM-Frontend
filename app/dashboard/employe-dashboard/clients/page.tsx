...
export default function ClientsListPage() {
    const [clients, setClients] = useState<Client[]>([
        { id: 1, name: "James Wilson", email: "james.wilson@client.co.uk", city: "London" },
        { id: 2, name: "Oliver Brown", email: "oliver.brown@client.co.uk", city: "Manchester" },
        { id: 3, name: "Emily Clarke", email: "emily.clarke@client.co.uk", city: "Birmingham" },
        { id: 4, name: "Sophia Taylor", email: "sophia.taylor@client.co.uk", city: "Leeds" },
        { id: 5, name: "Harry Thompson", email: "harry.thompson@client.co.uk", city: "Liverpool" },
        { id: 6, name: "Olivia Evans", email: "olivia.evans@client.co.uk", city: "Glasgow" },
        { id: 7, name: "William Johnson", email: "william.johnson@client.co.uk", city: "Edinburgh" },
    ]);
            ...
            <div className="flex-1 flex flex-col">
                ...
                {open && (
                    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm
                        ...
                        <div className="bg-gray-900 w-full max-w-md p-6
